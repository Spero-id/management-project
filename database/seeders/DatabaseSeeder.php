...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($quotationConditions as $conditionData) {
            \App\Models\QuotationCondition::create([
        ...
        $exchangeSetting = \App\Models\Setting::where('setting_name', 'currency_exchange_rate')->first();
        ...
        foreach ($salesUsers as $salesUser) {
            \App\Models\SalesTarget::create([
                ...
                'target_gross_profit' => rand(500000000, 2000000000), // 500M - 2B rupiah
                'target_monthly' => rand(100000000, 500000000), // 100M - 500M rupiah per month
                'target_yearly' => rand(1000000000, 5000000000), // 1B - 5B rupiah per year
                'year' => 2025,
            ]);
        }
