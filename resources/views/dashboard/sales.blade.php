                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="progress progress-md me-2"
                                                        style="flex: 1; min-width: 80px;">
                                                        <div class="progress-bar" style="width: {{ $progress }}%"
                                                            role="progressbar" aria-valuenow="{{ $progress }}"
                                                            aria-valuemin="0" aria-valuemax="100">
                                                            <span class="visually-hidden">{{ $progress }}%
                                                                Complete</span>
                                                        </div>
                                                    </div>
        ...
        function updateProspectsTable(prospects) {
            ...
            if (prospects.length === 0) {
                ...
                prospects.forEach(function(prospect, index) {
                    ...
                    const statusColor = prospect.prospect_status ? prospect.prospect_status.color || '#6c757d' :
                        '#6c757d';
                    const statusName = prospect.prospect_status ? prospect.prospect_status.name || 'Unknown' :
                        'Unknown';
