        ...
        <div class="card mb-4">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs">
                    ...
                    <li class="nav-item">
                        <a href="#minutes-of-meeting" class="nav-link" data-bs-toggle="tab">Minutes of Meeting</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="minutes-of-meeting">
                        <div class="mb-3">
                            <h4 class="mb-0">Minutes of Meeting</h4>
                        </div>

                        @if($minuteOfMeetings->count() > 0)
                            <div class="list-group">
                                @foreach($minuteOfMeetings as $mom)
                                    <div class="list-group-item">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div class="flex-grow-1">
                                                <div class="mb-2">
                                                    <small class="text-muted">
                                                        ...
                                                        {{ $mom->created_at->format('M d, Y H:i') }} 
                                                        by {{ $mom->creator->name ?? 'Unknown' }}
                                                    </small>
                                                </div>
                                                <div class="mb-2">
                                                    {!! nl2br(e($mom->body)) !!}
                        ...
                        @else
                            <div class="empty">
                                ...
                                <p class="empty-title">No minutes of meeting found</p>
                                <p class="empty-subtitle text-muted">No minutes of meeting have been recorded for this project yet.</p>
                            </div>
                        @endif
                    </div>
                </div>
