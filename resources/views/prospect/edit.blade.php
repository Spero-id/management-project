...
@section('header')
    <div class="row g-2 align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <a href="{{ route('projects.edit', 1) }}" class="btn btn-primary">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        Pengembangan sistem e-commerce lengkap untuk toko baju online yang mencakup katalog produk, sistem pembayaran, manajemen inventory, dan dashboard admin. 
                                        <br><br>
                        ...
                        <table class="table table-vcenter card-table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-2" style="background-image: url(https://ui-avatars.com/api/?name=Andi+Pratama&background=206bc4&color=fff)"></div>
                                            <div>
                                                <div class="fw-bold">Andi Pratama</div>
                                    ...
                                    <td>
                                        <div class="text-wrap">
                                            Masalah sumber daya telah diselesaikan. Tim kembali beroperasi dengan kapasitas penuh untuk finalisasi proyek.
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-2" style="background-image: url(https://ui-avatars.com/api/?name=Sari+Indrawati&background=dc3545&color=fff)"></div>
                                            <div>
                                    ...
                                    <td>
                                        <div class="text-wrap">
                                            Proyek dihentikan sementara menunggu persetujuan dari klien untuk perubahan requirements dan testing tambahan.
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-2" style="background-image: url(https://ui-avatars.com/api/?name=Budi+Santoso&background=28a745&color=fff)"></div>
                                            <div>
                                    ...
                                    <td>
                                        <div class="text-wrap">
                                            Fase development dimulai. Semua dokumen perencanaan telah disetujui oleh stakeholder dan client.
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-wrap">
                                            Setup awal proyek selesai. Mulai memasuki fase perencanaan detail dan alokasi resource tim.
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-2" style="background-image: url(https://ui-avatars.com/api/?name=System&background=6c757d&color=fff)"></div>
                                            <div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="progress flex-fill me-2" style="height: 6px; width: 60px;">
                                                <div class="progress-bar bg-light" role="progressbar" style="width: 5%"></div>
                                            </div>
                                    ...
                                    <td>
                                        <div class="text-wrap">
                                            Proyek berhasil dibuat dan ditugaskan kepada tim. Proses setup awal dan kick-off meeting dijadwalkan.
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
