                ...
                <div class="card">
                    <div class="card-body d-flex align-items-start gap-3">
                        ...
                        <div class="d-flex w-100 align-items-center">
                            <div>
                                <h5 class="mb-1">Related quotations</h5>
                                <p class="text-muted mb-0">
                                    This prospect has an associated quotation. You can view and download the quotation(s)
                                    below.
                                </p>
                            </div>

                            <div class="ms-auto">
                                <a href="{{ route('prospect.edit', $prospect->id) }}#quotation" class="btn btn-outline-primary" title="Edit prospect and jump to quotations" aria-label="Edit prospect">
