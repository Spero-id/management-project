                        ...
                        <table id="example" class="table table-selectable card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        <td><span class="text-secondary">{{ $user->no_karyawan }}</span></td>
                                        <td>{{ $user->unique_id }}</td>
                                        
                                        <td><a href="{{ route('user.show', $user->id) }}" class="text-reset" tabindex="-1">{{ $user->name }}</a></td>
                                        <td>{{$user->join_month}}-{{$user->join_year}}</td>
                                        <td>{{ $user->division->kode }}</td>
                                        <td>{{ $user->division->name }}</td>
                                        <td>
                                            <a href="{{ route('user.show', $user->id) }}" class="btn btn-icon" aria-label="View User">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <a href="{{ route('user.edit', $user->id) }}" class="btn btn-icon" aria-label="Edit User" title="Edit User">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <button class="btn btn-icon delete-user-btn" 
